...
export const ExactaMatrix: React.FC<ExactaMatrixProps> = ({ liveOdds, raceHistory }) => {
  ...
  return (
    ...
    >
      ...
      >
        <span
          className="text-gradient-gold font-display font-extrabold uppercase tracking-wider"
          style={{ fontSize: 14, marginBottom: 8 }}
        >
          Últimos Resultados
        </span>
        <div className="gold-divider" style={{ marginBottom: 10 }} />
          ...
          {raceHistory.length === 0 ? (
            ...
            raceHistory.map((race: any) => {
              ...
              return (
                ...
                >
                  <span style={{ color: '#9ca3af', fontFamily: 'monospace', fontWeight: 700, fontSize: 18, flexShrink: 0 }}>
                    #{race.numero}
                  </span>
                        ...
                        <span
                          ...
                          style={{
                            ...
                            background: dog.isStripes
                              ? 'repeating-linear-gradient(90deg,#111 0,#111 4px,#fff 4px,#fff 8px)'
                              : dog.color,
                            color: dog.textColor,
                  ...
                  <span style={{ color: '#6b7280', fontFamily: 'monospace', fontSize: 12, fontWeight: 600, flexShrink: 0 }}>
                    {fmtDate(race.finishedAt)} {fmtTime(race.finishedAt)}
                  </span>
                </div>
              );
            })
